...
\textls[-20]{É a história dos antepassados. Tambem existiam monstros com outros
...
\textls[-5]{Quem eram os dois tuxauas? O irmão mais velho e o irmão mais novo
...
\letra{É}{um tatu!} \textls[-5]{Dizemos assim. Tatu estava andando. Yanomami, Tatu, tatu.
...
\letra{E}{m seguida}, \textls[-29]{segue a história daquele que fez as onças se multiplicarem.
...
\letra{H}{á a história} \textls[-5]{para nós, Yanomami; nos perdermos na mata, ensinou-se,
